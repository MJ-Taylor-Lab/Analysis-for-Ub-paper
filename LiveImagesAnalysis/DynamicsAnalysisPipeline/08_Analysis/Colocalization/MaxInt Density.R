...
ggplot(
  ...
  scale_color_manual(values = c("#d7191c","#000000")) + #TRAF6
  scale_color_manual(values = c("#2c7bb6","#000000")) + #HOIL1
  ...
  scale_y_continuous( 
    #limits = c(0, 0.22), #TRAF6
    limits = c(0, 0.14), #HOIL1
    label = limits
    #label = mult_format
  ) +
  labs(
    ...
    y = "Density (%)",
    x = paste(lp.PROTEIN_FLUOROPHORE, " Max puncta size (# of ",lp.PROTEIN, ")", sep = ""),
