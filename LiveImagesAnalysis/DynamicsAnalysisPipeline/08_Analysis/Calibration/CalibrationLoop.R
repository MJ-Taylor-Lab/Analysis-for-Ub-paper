...
tryCatch({
  ...
  CalibrationInput <-
    ...
    mutate(
      PROTEIN_CALIBRATION_MEAN = is.na(PROTEIN_CALIBRATION_MEAN) | PROTEIN_CALIBRATION_MEAN == ""
    ) %>%
    filter(
      PROTEIN_CALIBRATION_MEAN == TRUE
    )
  ...
  CalibrationFx <-
    function(CalibrationImageX) {
      tryCatch({
        ...
        IMAGE = CalibrationInput$PROTEIN_CALIBRATION[CalibrationImageX]
        PROTEIN_CALIBRATION_BACKGROUND =
          CalibrationInput$PROTEIN_CALIBRATION_BACKGROUND[CalibrationImageX]
        KEEP = CalibrationInput$KEEP[CalibrationImageX]
        PROTEIN_CALIBRATION_DATE = CalibrationInput$PROTEIN_CALIBRATION_DATE[CalibrationImageX]
        #Change directory
